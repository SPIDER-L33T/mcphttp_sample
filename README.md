...
И замените `url` если Ваш сервер развернут на отдельном хосте, типа, `"url": "http://mytime.mydomen.com:8000/"`
...
- Можете отправить Фродо и Сэма пешим ходом в качестве почтовых курьеров (до Мордора дошли - и до меня дойдут).
